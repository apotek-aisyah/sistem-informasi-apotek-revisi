  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
       ...
       <form action="<?php echo base_url(). 'pembelian/add_purchase'; ?>" method="post" class="form-horizontal form-label-left" novalidate>
              ...
              <select name="nama_pemasok" id="nama_pemasok" class="select2_single form-control nama_pemasok" tabindex="-1" required="required">
                <option selected="true" value="" disabled ></option>
                    <?php foreach ($pemasok as $row) {?>
                        <option value='<?php echo $row->pem?>'><?php echo $row->nama_pemasok?></option>
                    <?php }?>
              </select>
            </div>
          </div>
