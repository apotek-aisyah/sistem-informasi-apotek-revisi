  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form action="<?php echo base_url(). 'kategori/update_category'; ?>" method="post" class="form-horizontal form-label-left" novalidate >
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
              <a href="<?php echo base_url('kategori/table_cat') ?>"><button type="button" class="btn btn-danger">Batal</button></a>
