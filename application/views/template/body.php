...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/images/apt.jpg') ?>" type="image/jpg" />
		...
		<div class="main_container">
			...
			<footer>
				<div class="pull-right">
					<a href=""> Sistem Informasi  <a href="" title="" target="_blank"> Pendeteksi Expired Obat</a> | Apotek Asyifa</a> <?php  $footer; ?>
				</div>
				<div class="clearfix"></div>
			</footer>
			<!-- /Footer Content -->
